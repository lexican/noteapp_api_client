...
import 'package:noteapp_api_client/src/api_util.dart';
...
class NoteApi {
  ...
  const NoteApi(this._dio, this._serializers);

  /// Add new note
  /// 
  ///
  /// Parameters:
  /// * [createNoteModel] - Add new note
  ...
  Future<Response<GetNotesResponse>> addNote({ 
    ...
    try {
      const _type = FullType(CreateNoteModel);
      _bodyData = createNoteModel == null ? null : _serializers.serialize(createNoteModel, specifiedType: _type);
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BaseResponse>> deleteNoteById({ 
    ...
    final _path = r'/notes/{noteId}'.replaceAll('{' r'noteId' '}', encodeQueryParameter(_serializers, noteId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [GetNotesResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetNotesResponse>> getAllNotes({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetNoteResponse>> getNoteById({ 
    required String noteId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Parameters:
  /// * [noteId] - Note ID
  /// * [updateNoteModel] - Update new note
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [GetNoteResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<GetNoteResponse>> updateNote({ 
    required String noteId,
    ...
    try {
      const _type = FullType(UpdateNoteModel);
      _bodyData = updateNoteModel == null ? null : _serializers.serialize(updateNoteModel, specifiedType: _type);
